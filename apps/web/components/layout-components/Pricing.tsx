  ...
  return (
    ...
    >
      ...
      <div className="flex items-end gap-[4px]">
        ...
        <span className="font-ibm-mono text-[13px] text-[#555555] tracking-[1px] mb-[6px]">
          /MO
        </span>
      </div>
      ...
      <div
        ...
        style={{ borderTop: `1px solid ${borderColor === "#0F0F0F" ? "#2D2D2D" : borderColor}` }}
      >
...
export default function Pricing() {
  return (
    ...
    >
      <SectionHeader label="[09] // PRICING" title={"SIMPLE PRICING.\nNO SURPRISES."} />
