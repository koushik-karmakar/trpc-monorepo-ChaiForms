  ...
  return (
    <section className="relative flex flex-col items-center w-full bg-[#0A0A0A] py-16 px-6 md:py-[100px] md:px-[120px] overflow-hidden">
      ...
      <h1 className="font-grotesk text-[clamp(32px,10vw,96px)] font-bold text-[#F5F5F0] tracking-[-1px] leading-none text-center w-full max-w-[1100px]">
        <GlitchText text="FORMS THAT" speed={45} delay={100} />
        <br />
        <GlitchText text="CONVERT." speed={45} delay={400} />
      </h1>
      <h1 className="font-grotesk text-[clamp(32px,10vw,96px)] font-bold text-[#FFD600] tracking-[-1px] leading-none text-center w-full max-w-[1100px]">
        <GlitchText text="BEAUTIFULLY." speed={45} delay={700} />
      </h1>
      ...
      <p className="font-ibm-mono text-[13px] md:text-[15px] text-[#888888] tracking-[1px] leading-[1.6] text-center w-full max-w-[800px]">
        THE MODERN FORM BUILDER FOR TEAMS WHO CARE ABOUT EXPERIENCE.
        <br />
        FROM FIRST QUESTION TO FINAL SUBMISSION.
      </p>
      ...
      <p className="font-ibm-mono text-[11px] text-[#555555] tracking-[2px] text-center">
        NO CREDIT CARD // FREE FOREVER PLAN // 500+ FORMS CREATED
      </p>
...
const layers = [
  { label: "FORM / SURVEY", color: "#FFD600", indent: 0, active: true },
  { label: "WELCOME SCREEN", color: "#888", indent: 12 },
  { label: "EMAIL FIELD", color: "#4ADE80", indent: 12 },
  { label: "RATING SCALE", color: "#888", indent: 12 },
  { label: "BUTTON GROUP", color: "#FF6B35", indent: 12 },
  { label: "BTN / SUBMIT", color: "#FF6B35", indent: 24 },
  { label: "BTN / SKIP", color: "#888", indent: 24 },
  { label: "THANK YOU PAGE", color: "#60A5FA", indent: 12 },
  { label: "LOGIC RULES", color: "#888", indent: 0 },
];
...
const inspectProps = [
  ...
  { key: "ACCENT", val: "#FFD600", swatch: "#FFD600" },
  { key: "BORDER", val: "0px" },
  { key: "COMPLETE", val: "73%" },
];
